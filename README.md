...
- No real YARA adapter yet
- CI and CodeQL are configured but not yet verified on GitHub
- Threshold matching is intentionally simple
- Reports are local educational artifacts only
- Directory scanning is non-recursive by design
- No production telemetry collection or external scanning
- No fake screenshots are included; example reports are real local generated outputs.
